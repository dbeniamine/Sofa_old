...
#define LOCAL_LIKWID_MARKER_START(A) LIKWID_MARKER_START(A)
#define LOCAL_LIKWID_MARKER_STOP(A) LIKWID_MARKER_STOP(A)
#else
#define LOCAL_LIKWID_MARKER_START(A) 
#define LOCAL_LIKWID_MARKER_STOP(A) 
#endif
